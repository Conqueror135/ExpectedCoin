...
//       if(hf.WriteFileConfig(new Config("D:\\EPC\\","ThangThanThanh","123",true))){
...
//        a1.setMiner("1Bf9sZvBHPFGVPX71WX2njhd1NXKv5y7v5");
//        a1.setTimestamp(java.time.LocalDateTime.now().toString());
